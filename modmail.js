                ...
                if(cmd && cmd.length > 0){
                    if(cmd == "invite" || cmd == "add"){
                            ...
                            return message.reply({
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                        .setColor("RED")
                                        .setTitle("❌ You have not setup the bot before!")
                                    ]
                            }).catch(console.error)
                        }
                            ...
                            return message.reply({
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setDescription(`You can now delete it if you want!`)
                                    ]
                            }).catch(console.error)
                        } else {
                            return message.reply({
                        ...
                        embeds.push(new Discord.MessageEmbed()
                            ...
                            .setDescription(`Hello I am ${guild.me.user.username} and i am an easy 2 setup and use Modmail-bot!\n> A Modmail Bot is a Bot similar to a Ticket Bot which allows you to DM with The Ticket User instead of Using a Ticket! It's easier for them and i have an advance Ticket Logger too!\n\n**These are my Commands:**\n\n\`Jake He#9816\` Coded me and here is my [Github](https://github.com/Jakethebest1238) profile!`)
                            .addField("Discord **Support Server**", `> Join my [Support Server](https://dsc.gg/jakesnation)`)
            ...
            return message.reply({
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                        .setColor("RED")
                        .setTitle("❌ This Guild has not setup the bot yet!")
